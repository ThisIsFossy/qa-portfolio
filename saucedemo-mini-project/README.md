...
В рамках мини-проекта были проверены основные пользовательские сценарии сайта Saucedemo: авторизация, каталог, корзина и оформление заказа.
...
Проект можно использовать как первый учебный пример в портфолио начинающего QA-инженера.
